# Prove of design tokens concept

Demonstrate an idea Design systems may be created by using design tokens, which can then be exported to a json file and sent to the front end for compilation into SCSS variables using a [style dictionary](https://amzn.github.io/style-dictionary/#/).

## Basic Style Dictionary
---

[This example code](https://github.com/amzn/style-dictionary/tree/main/examples/basic) is bare-bones to show you what this framework can do. If you have the style-dictionary module installed globally, you can `cd` into this directory and run:
```bash
